...
for random_seed in 1 12 123 1234 12345; do
    python transfer.py --horizon 25 --num_threads 25 --temp_path result/transfer_${random_seed}_po_online --seed ${random_seed} \
    ...
    python transfer.py --horizon 25 --num_threads 25 --temp_path result/transfer_${random_seed}_po_online --seed ${random_seed} \
        ...
        --opt_sampling True --target True --online True
done